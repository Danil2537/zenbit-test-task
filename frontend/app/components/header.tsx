...
//             <Link
//               href="/auth/signup"
//               className="flex h-11 min-w-[10rem] items-center justify-center rounded-md bg-[#B29F7E] px-6 font-heading text-base text-white font-semibold transition hover:bg-gray-100"
//             >
//               Sign Up
//             </Link>
//           </div>
